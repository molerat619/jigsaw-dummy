...
var cookieconsent = function (e) {
        ...
        return n.toString = function () {
            ...
            n.i = function (e, o) {
                ...
                for (i = 0; i < e.length; i++) {
                    var r = e[i];
                    null != r[0] && t[r[0]] || (o && !r[2] ? r[2] = o : o && (r[2] = "(" + r[2] + ") and (" + o + ")"),
                        n.push(r))
                }
            }
            ,
    ...
    , function (e, n, o) {
        var t, i, a = {}, r = (t = function () {
            return window && document && document.all && !window.atob
        }
            ,
            function () {
                return void 0 === i && (i = t.apply(this, arguments)),
                    i
            }
        ), s = function (e) {
            var n = {};
            ...
            for (var o = 0; o < e.length; o++) {
                ...
                if (i) {
                    ...
                    for (; r < t.parts.length; r++)
                        i.parts.push(h(t.parts[r], n))
                } else {
                    var s = [];
                    for (r = 0; r < t.parts.length; r++)
                        s.push(h(t.parts[r], n));
                    a[t.id] = {
                        id: t.id,
                        refs: 1,
                        parts: s
        ...
        function k(e, n) {
            ...
            var t = p[p.length - 1];
            if ("top" === e.insertAt)
                t ? t.nextSibling ? o.insertBefore(n, t.nextSibling) : o.appendChild(n) : o.insertBefore(n, o.firstChild),
                    p.push(n);
        ...
        function h(e, n) {
            ...
            if (n.transform && e.css) {
                if (!(a = "function" == typeof n.transform ? n.transform(e.css) : n.transform.default(e.css)))
                    return function () { }
                        ;
                e.css = a
            }
    ...
    , function (e, n) {
        e.exports = function (e) {
            ...
            return e.replace(/url\s*\(((?:[^)(]|\((?:[^)(]+|\([^)(]*\))*\))*)\)/gi, function (e, n) {
                ...
                return /^(#|data:|http:\/\/|https:\/\/|file:\/\/\/|\s*$)/i.test(a) ? e : (i = 0 === a.indexOf("//") ? a : 0 === a.indexOf("/") ? o + a : t + a.replace(/^\.\//, ""),
            ...
            return e.insertCss = function (e) {
                ...
                e.appendChild = function (e, n, o) {
                    ...
                    return void 0 === o && (o = null),
                        ...
                        "afterbegin" === o ? t.insertAdjacentElement("afterbegin", i) : t.insertAdjacentElement("beforeend", i),
                        !0
                }
                ,
                e.setCookie = function (e, n, o) {
                    ...
                    return document.cookie = e + "=" + (n || "") + i + "; path=/",
                        !0
                }
                ,
        ...
        var y, w, z = (y = function (e, n) {
            ...
            return e.prototype.readScripts = function () {
                ...
                e.prototype._noticeScriptIfValid = function (e) {
                    ...
                    !0 === t.searchObjectsArray(this.cookieConsent.cookieLevels.cookieLevels, "id", n) ? (this.cookieConsent.log("Javascript with valid cookie consent found", "info"),
                        ...
                        void 0 === this.scripts[n] && (this.scripts[n] = []),
            ...
            return e.prototype.checkIfUserAccepted = function () {
                ...
                e.prototype.markUserAccepted = function () {
                    this.userAccepted = !0,
                        !1 === this.cookieConsent.isDemo && t.setCookie(this.consentAcceptedCookieName, "true")
                }
                ,
                e.prototype.getUserLevels = function () {
                    ...
                    if (null === n)
                        ...
                        for (var o in this.cookieConsent.cookieLevels.cookieLevels) {
                            ...
                            !0 === n[i] ? this.acceptedLevels[i] = !0 : this.acceptedLevels[i] = !1,
                                this.saveCookie()
                        }
                ...
                e.prototype.checkIsAccepted = function (e) {
                    var n = !1;
                    return e in this.acceptedLevels && !0 === this.acceptedLevels[e] && (n = !0),
                        n
                }
                ,
                ...
                e.prototype.saveCookie = function () {
                    ...
                    return t.setCookie(this.consentLevelCookieName, e),
                ...
                e.prototype.cc_dialogOkPressed = function () {
                    ...
                    document.addEventListener("cc_dialogOkPressed", function () {
                        e.cookieConsent.log("cc_dialogOkPressed triggered", "event"),
                            e.cookieConsent.consentType instanceof N ? (e.cookieConsent.userConsent.markUserAccepted(),
            ...
            return e.prototype.listenToUserButtonToOpenPreferences = function (e) {
                ...
                o && o.addEventListener("click", function () {
                    document.dispatchEvent(n.cookieConsent.events.cc_dialogPreferencesPressed),
                        n.showPreferences()
                })
            }
                ,
                ...
                e.prototype.createPreferencesOverlayAndDialog = function () {
                    ...
                    if (a.classList.add("cc_cp_head_title"),
                ...
                e.prototype.obtainLanguageSelector = function () {
                    ...
                    return [].forEach.call(e.cookieConsent.i18n.availableLanguages, function (o) {
                        ...
                        t.text = o.title,
                            t.value = o.value,
                            e.cookieConsent.i18n.userLang === t.value && t.setAttribute("selected", "selected"),
                            n.add(t)
                    }),
                ...
                e.prototype.getContentContainer = function () {
                    ...
                    return e.cookieConsent.cookieLevels.preferenceItems.forEach(function (i) {
                        var a = document.createElement("div");
                        if (a.classList.add("cc_cp_m_content_entry"),
                            a.setAttribute("content_layout", i.content_container),
                            a.setAttribute("active", "false"),
                            a.innerHTML = i.content,
                            0 === o && a.setAttribute("active", "true"),
                            o++,
                            i.id) {
                ...
                e.prototype.getFooterContainer = function () {
                    ...
                    o.classList.add("cc_cp_f_powered_by"),
                        o.innerHTML = t.magicTransform("Q29va2llIENvbnNlbnQgYnkgPGEgaHJlZj0iaHR0cHM6Ly93d3cudGVybXNmZWVkLmNvbS9jb29raWUtY29uc2VudC8iIHRhcmdldD0iX2JsYW5rIj5UZXJtc0ZlZWQ8L2E+");
                    var i = document.createElement("div");
                    i.classList.add("cc_cp_f_save");
                    var a = document.createElement("button");
                    return a.innerHTML = e.cookieConsent.i18n.$t("preference_center", "save"),
                ...
                e.prototype._getLevelCheckbox = function (e) {
                    ...
                    if ("strictly-necessary" !== e.id) {
                        ...
                        a.setAttribute("cookie_consent_toggler", "true"),
                            ...
                            a.setAttribute("class", "checkbox_cookie_consent"),
                            a.setAttribute("id", e.id),
                            a.setAttribute("name", e.id),
                            (r = document.createElement("label")).setAttribute("for", e.id),
                            i[e.id] ? (a.setAttribute("checked", "checked"),
                                r.setAttribute("class", "is-active"),
                                r.innerHTML = n.cookieConsent.i18n.$t("dialog", "active")) : (r.setAttribute("class", "is-inactive"),
                                    r.innerHTML = n.cookieConsent.i18n.$t("dialog", "inactive")),
                            a.addEventListener("change", function () {
                                ...
                                n.cookieConsent.log("User changed toggle for cookie level [" + t + "], new status: " + o, "info"),
                                    ...
                                    !0 === o ? (n.cookieConsent.userConsent.acceptLevel(t),
                        ...
                        s.setAttribute("cookie_consent_toggler", "true"),
                            ...
                            (r = document.createElement("label")).setAttribute("for", e.id),
                            r.innerHTML = n.cookieConsent.i18n.$t("dialog", "always_active"),
                            t.appendChild(o, s),
                            t.appendChild(o, r)
                    }
                    return o
            ...
            return e.prototype.initDialog = function () {
                ...
                e.prototype.createDialog = function () {
                    ...
                    if (t.appendChild(e, this.createDialogContent()),
                        "interstitial" === this.cookieConsent.userNoticeType) {
                        var a = document.createElement("div");
                        return a.classList.add("cc_overlay_lock"),
                            t.appendChild(a, e),
                            a
                    }
                    return e
                ...
                e.prototype.createDialogContent = function () {
                    ...
                    a.classList.add("cc_dialog_text"),
                        a.innerHTML = e.cookieConsent.i18n.$t("dialog", "text"),
                        t.appendChild(i, a);
                    ...
                    s.classList.add("cc_b_cp"),
                        s.classList.add("ml-1"),
                        s.innerHTML = e.cookieConsent.i18n.$t("dialog", "change_settings"),
                        s.addEventListener("click", function () {
                            document.dispatchEvent(e.cookieConsent.events.cc_dialogPreferencesPressed)
                        });
                    var c = document.createElement("div");
                    return t.appendChild(c, r),
                        t.appendChild(c, s),
                        t.appendChild(n, o),
                        t.appendChild(n, i),
                        t.appendChild(n, c),
            ...
            function e(e) {
                ...
                this.events = new x,
                    this.eventsListeners = new L(this),
                    this.i18n = new b(this),
                    this.cookieLevels = new E(this),
                    this.userConsent = new C(this),
                    this.javascriptItems = new j(this),
                    this.consentPreferences = new S(this),
            ...
            return e.prototype.log = function (e, n, o) {
                void 0 === o && (o = "log"),
                    !0 === this.debug && ("log" === o ? console.log("[" + n + "]", e) : "table" === o && console.log("[" + n + "]", e))
            }
                ,
                e
        }(), R = function (e) {
